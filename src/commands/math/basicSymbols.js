...
(function() {
  var mostOps = ('arg det dim exp gcd hom ker lg lim ln log max min sup'
...
CharCmds['*'] = LatexCmds.sdot = LatexCmds.cdot = LatexCmds.t =
...
LatexCmds['×'] = LatexCmds.times = LatexCmds.x = bind(BinaryOperator, '\\times ', '&times;', '[x]');
